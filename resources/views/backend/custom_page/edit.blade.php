...
<div class="m-content">
	...
	<div class="m-portlet m-portlet--mobile">
		...
		<!--begin::Form-->
		{{ Form::model($record, array('route' => ['backend.custom-page.update', $record->id], 'id'=>'edit-custom-page-form', 'class' => 'm-form')) }}
		@method('PUT')
			...
			<div class="m-form__actions m-form__actions">
				<div class="row">
					...
					<div class="col-lg-9">
						...
						<a href="{{route('backend.custom-page.index')}}" class="btn btn-secondary">Cancel</a>
					</div>
				</div>
			</div>
		</div>
...
@endsection
@section('scripts')
{!! JsValidator::formRequest('App\Http\Requests\Backend\CustomPageRequest', '#edit-custom-page-form'); !!}
