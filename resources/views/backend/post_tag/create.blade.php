...
<div class="m-content">
	...
	<div class="m-portlet m-portlet--mobile">
		...
		<!--begin::Form-->
		{{ Form::open(array('route' => 'backend.posts.tag.store', 'id'=>'create-tag-form', 'class' => 'm-form', 'files' => true)) }}
...
@endsection
@section('scripts')
{!! JsValidator::formRequest('App\Http\Requests\Backend\BlogTagRequest', '#create-tag-form'); !!}
@endsection