...
<div class="m-content">
	...
	<div class="m-portlet m-portlet--mobile">
		...
		<!--begin::Form-->
		{{ Form::model($record, array('route' => ['backend.glossary.update', $record->id], 'id'=>'edit-glossary-form', 'class' => 'm-form', 'files' => true)) }}
		@method('PUT')
...
@endsection
@section('scripts')
{!! JsValidator::formRequest('App\Http\Requests\Backend\GlossaryRequest', '#edit-about-form'); !!}
